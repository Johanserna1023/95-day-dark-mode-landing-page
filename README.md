...
Esta es una solución del proyecto **Dark Mode Landing Page** como parte del reto de codificación #100DaysOfProjects [Front End Club](https://www.facebook.com/frontendclubfb). La mejor manera de escribir un buen código es programando todos los días🔥.
...
Usamos `javascript` para dar el menu toggle:
